...
draw_3d_helpers_array = [];//this one is not automatic
...
var _pathstring = string(working_directory) + "maps\\" + "mini_test_002";
//var _pathstring = string(working_directory) + "maps\\" + "Load_nothing";
