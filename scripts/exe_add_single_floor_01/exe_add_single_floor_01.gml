function exe_add_single_floor_01(_initial_pm)
{
	//3d obj start
	var _temp_o = {};
	...
	_temp_o.character_sheet = {		name: "floor_swapable_01", hash: exe_return_hash(	string_join("|",current_time,date_current_datetime(),string(string_length(map3d)))	),
	...
	struct_set(_temp_o.character_sheet, "items_swaps",		"floor_items_swaps_01"	);
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_floor_01_show","1.","N"]						];
	_temp_o.part_texture_shader_setings =		[	[7.,1.,0.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_floor_01_colider","1.","N"]						];
