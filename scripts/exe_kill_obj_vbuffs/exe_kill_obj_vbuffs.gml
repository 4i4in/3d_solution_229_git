					...
					if _obj.part_show_curent[_ii] != undefined
						{
							...
							if  _kill > 0	{	vertex_delete_buffer(_obj.part_show_curent[_ii]);	};
						}
				}
					...
					if _obj.part_helpers_curent[_ii] != undefined
						{
							...
							if  _kill > 0	{	vertex_delete_buffer(_obj.part_helpers_curent[_ii]);	};
						}
				}
					...
					if _obj.part_colisions_curent[_ii] != undefined
						{
							...
							if  _kill > 0	{	vertex_delete_buffer(_obj.part_colisions_curent[_ii]);	};
						}
				}
		}
