...
//===========================================page
					case 7:
							...
							var _btext = "static_major : " + string(_curent_shader[0]); var _lclick = "exe_change_shader_settings_in_cam"; var _rclick = "show_rclick_info"; var _carry = ["shd_pass_seq",0,0.,"switch"];	var _info = "s0l1 control";
							var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
							array_push(_this_menu,_button);
							...
							var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
							var _pic = "_32x384_back";	var _pic_mo = string(_pic) + "_mo";	var _mouse_over = 0;
							var _btext = "static_minor : " + string(_curent_shader[1]); var _lclick = "exe_change_shader_settings_in_cam"; var _rclick = "show_rclick_info"; var _carry = ["shd_pass_seq",1,0.,"switch"];	var _info = "s0l1 control";
							var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
							array_push(_this_menu,_button);
							...
							var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
							var _pic = "_32x384_back";	var _pic_mo = string(_pic) + "_mo";	var _mouse_over = 0;
							var _btext = "controled : " + string(_curent_shader[2]); var _lclick = "exe_change_shader_settings_in_cam"; var _rclick = "show_rclick_info"; var _carry = ["shd_pass_seq",2,0.,"switch"];	var _info = "s0l1 control";
							var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
							array_push(_this_menu,_button);
