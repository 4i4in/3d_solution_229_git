function exe_render3d_for(_current_cam,_draw_3d_array)
{
	//surface_set_target(_current_cam.temp_surf_depth);
	//draw_surface(_current_cam.surf_depth,0,0);
	...
	texture_set_stage(shader_get_sampler_index(shd_3d_02,"tex_g_buff"),_current_cam.temp_surf_depth);
