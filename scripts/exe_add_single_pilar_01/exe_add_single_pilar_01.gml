function exe_add_single_pilar_01(_initial_pm)
{
	...
	_temp_o.part_vbuff_load_reference =			[	["vbuff_pilar_03_show","1.","N"]					];
	_temp_o.part_texture_shader_setings =		[	[7.,5.,0.]			];	//material true/false
	
	_temp_o.part_vbuff_colider_load_reference = [	["vbuff_pilar_03_colider","1.","N"]					];
