function exe_create_world_control_menu()
{
	...
	//===========================================page
					case 5:
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "add new static objects to world"; var _lclick = ""; var _rclick = "show_rclick_info"; var _carry = [];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "position : " + string(_spawnin_point); var _lclick = ""; var _rclick = "show_rclick_info"; var _carry = [];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "add_single_openwall_01"; var _lclick = "exe_add_static_object_to_map_by_click"; var _rclick = "show_rclick_info"; var _carry = ["exe_add_single_openwall_01",_spawnin_point];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "add_single_floor_01"; var _lclick = "exe_add_static_object_to_map_by_click"; var _rclick = "show_rclick_info"; var _carry = ["exe_add_single_floor_01",_spawnin_point];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
	...
	//===========================================page
					case 6:
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "add new dynamic objects to world"; var _lclick = ""; var _rclick = "show_rclick_info"; var _carry = [];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
						...
						var _xx2 = floor(_xx1+_button_size[0] * _tsize); var _yy2 = floor(_yy1+_button_size[1]	* _tsize);
						var _pic = "_32x384_back";	var _pic_mo = string(_pic);	var _mouse_over = 0;
						var _btext = "add_door_01"; var _lclick = "exe_add_dynamic_object_to_map_by_click"; var _rclick = "show_rclick_info"; var _carry = ["exe_add_door_01",_spawnin_point];		var _info = "info mouse_menu";
						var _button = [_xx1,_yy1,_xx2,_yy2,_pic,_pic_mo,_mouse_over,_btext,_lclick,_rclick,_carry,_info];
						array_push(_this_menu,_button);
